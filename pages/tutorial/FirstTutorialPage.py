...
from pages.tutorial.SecondTutorialPage import SecondTutorialPage
...
class FirstTutorialPage(QWidget):
    def __init__(self, parent=None, audio="01_powitanie.wav"):
    ...
    def on_tutorial_btn_click(self):
        self.next_page = SecondTutorialPage()
        self.next_page.start()
        self.hide()

    def on_again_btn_click(self):
        self.start()  ## TODO: posprzatac kod i porobic komentazre

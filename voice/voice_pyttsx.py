...
kwestie = [
    ("Witaj! Jak się masz dzisiaj?", "audio\\pyttsx\\01_powitanie.wav"),
    ("Świetnie ci idzie! Jesteś super!", "audio\\pyttsx\\02_pochwala.wav"),
    ("Spróbuj jeszcze raz. Wierzę w ciebie!", "audio\\pyttsx\\03_zacheta.wav"),
    ("Brawo! To była dobra odpowiedź!", "audio\\pyttsx\\04_brawo.wav"),
    ("Czas na przerwę. Pamiętaj, żeby się napić wody!", "audio\\pyttsx\\05_przerwa.wav"),
]
